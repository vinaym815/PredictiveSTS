...
Invert(int aN,const double *aM,double *rMInv)
{
    ...
    Mp = new double*[aN];      // POINTER TO BEGINNING OF POINTER1 SPACE
    Mr = new double*[aN];      // ROW POINTERS INTO M
    Ip = new double*[aN];     // POINTER TO BEGINNING OF POINTER2 SPACE
    Ir = new double*[aN];      // ROW POINTERS INTO aMInv
