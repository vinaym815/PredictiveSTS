...
void computeCostsStanding(std::vector<double> &costs, OpenSim::Model &osimModel, const SimTK::State siFinal) {
  ...
  osimModel.realizePosition(siFinal);
  ...
  const SimTK::Vec3 feetPos = talus.getPositionInGround(siFinal);
  const SimTK::Vec3 heelPos = heelCnctFrame->getPositionInGround(siFinal);                                                    
  const SimTK::Vec3 toesPos = toesCnctFrame->getPositionInGround(siFinal);                                                    
