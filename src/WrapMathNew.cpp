                    ...
                    SimTK::Vec3& pInt1, double& s, SimTK::Vec3& pInt2, double& t)
{
    ...
    double mag1 = MtxNew::Normalize(3, vec1, vec1);

    vec2 = p4 - p3;

    double mag2 = MtxNew::Normalize(3, vec2, vec2);

    MtxNew::CrossProduct(vec1, vec2, cross_prod);
                             ...
                             SimTK::Vec3& inter)
{
    ...
    double dotprod = MtxNew::DotProduct(3, vec,plane);
                                      ...
                                      SimTK::Vec3& closestPt, double& t)
{
    ...
    v2 = line;
    double mag = MtxNew::Normalize(3, v1, v1);
    double mag2 = MtxNew::Normalize(3, v2, v2);
    t = MtxNew::DotProduct(3, v1, v2) * mag;
...
ConvertAxisAngleTo4x4DirCosMatrix(const SimTK::Vec3& axis, double angle, double mat[][4])
{
    ...
    MtxNew::Identity(4, (double*)mat);
    MtxNew::Normalize(3, axis, normAxis);
...
RotateMatrixQuaternion(double matrix[][4], const double quat[4])
{
    ...
    MtxNew::Multiply(4, 4, 4, (double*)matrix, (double*)n, (double*)matrix);
}
