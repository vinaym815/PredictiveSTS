...
static const char* wrapTypeName = "cylinderNew";
...
* Default constructor.
*/
WrapCylinderNew::WrapCylinderNew() : WrapObject()
{
    constructProperties();
}
...
* Destructor.
*/
WrapCylinderNew::~WrapCylinderNew()
{}
...
*/
void WrapCylinderNew::constructProperties()
{
    constructProperty_radius(1.0);
    constructProperty_length(1.0);
}

void WrapCylinderNew::extendScale(const SimTK::State& s, const ScaleSet& scaleSet)
{
...
*/
void WrapCylinderNew::extendFinalizeFromProperties()
{
    // Base class
 ...
 */
const char* WrapCylinderNew::getWrapTypeName() const
{
    return wrapTypeName;
}
 ...
 */
string WrapCylinderNew::getDimensionsString() const
{
 ...
 */
int WrapCylinderNew::wrapLine(const SimTK::State& s, SimTK::Vec3& aPoint1, SimTK::Vec3& aPoint2,
                                    const PathWrap& aPathWrap, WrapResult& aWrapResult, bool& aFlag) const
{
    ...
    if (WrapMathNew::CalcDistanceSquaredPointToLine(aPoint1, p0, dn) < r_squared ||
        WrapMathNew::CalcDistanceSquaredPointToLine(aPoint2, p0, dn) < r_squared)
    {
        return insideRadius;
    }
    ...
    WrapMathNew::IntersectLines(aPoint1, aPoint2, cylStart, cylEnd, near12, t12, near00, t00);
    ...
    if ( ! constrained)
    {
        if (WrapMathNew::CalcDistanceSquaredBetweenPoints(near12, near00) < r_squared && t12 > 0.0 && t12 < 1.0)
        {
    ...
    WrapMathNew::GetClosestPointOnLineToPoint(aPoint1, p0, dn, p11, t);
    WrapMathNew::GetClosestPointOnLineToPoint(aPoint2, p0, dn, p22, t);
    ...
    WrapMathNew::GetClosestPointOnLineToPoint(mpt, p0, dn, axispt, t);
    ...
    // pick the right one.
    dist1 = WrapMathNew::CalcDistanceSquaredBetweenPoints(mpt, apex1);
    dist2 = WrapMathNew::CalcDistanceSquaredBetweenPoints(mpt, apex2);
    if (far_side_wrap)
    {
        if (dist1 < dist2)
        {
    ...
    r1_inter = WrapMathNew::IntersectLineSegPlane(r1a, r1b, plane_normal, d, r1p);
    r2_inter = WrapMathNew::IntersectLineSegPlane(r2a, r2b, plane_normal, d, r2p);

    if (r1_inter)
    {
        WrapMathNew::GetClosestPointOnLineToPoint(r1p, p11, p22, r1a, t);

        if (WrapMathNew::CalcDistanceSquaredBetweenPoints(r1a, p22) < WrapMathNew::CalcDistanceSquaredBetweenPoints(p11, p22))
            for (i = 0; i < 3; i++)
    ...
    if (r2_inter)
    {
        WrapMathNew::GetClosestPointOnLineToPoint(r2p, p11, p22, r2a, t);

        if (WrapMathNew::CalcDistanceSquaredBetweenPoints(r2a, p11) < WrapMathNew::CalcDistanceSquaredBetweenPoints(p22, p11))
            for (i = 0; i < 3; i++)
 ...
 * @param aWrapResult The result of the wrapping (tangent points, etc.)
 */
void WrapCylinderNew::_make_spiral_path(SimTK::Vec3& aPoint1,
                                                 SimTK::Vec3& aPoint2,
                                                 bool far_side_wrap,
...
restart_spiral_wrap:
    ...
    WrapMathNew::GetClosestPointOnLineToPoint(aWrapResult.r1, p0, dn, r1a, t);
    WrapMathNew::GetClosestPointOnLineToPoint(aWrapResult.r2, p0, dn, r2a, t);
 ...
 */
void WrapCylinderNew::_calc_spiral_wrap_point(const SimTK::Vec3& r1a,
                                                         ...
                                                         SimTK::Vec3& wrap_pt) const
{
    ...
    WrapMathNew::RotateMatrixAxisAngle(n, axis, sense * t * theta);
 ...
 */
bool WrapCylinderNew::_adjust_tangent_point(SimTK::Vec3& pt1,
                                                      SimTK::Vec3& dn,
                                                      SimTK::Vec3& r1,
                                                      SimTK::Vec3& w1) const
{
    ...
    if (fabs(alpha - omega) > TANGENCY_THRESHOLD)
    {
        ...
        WrapMathNew::GetClosestPointOnLineToPoint(pt1, r1, dn, p1a, t);
        WrapMathNew::GetClosestPointOnLineToPoint(w1, r1, dn, w1a, t);

        WrapMathNew::IntersectLines(pt1, w1, p1a, w1a, p1w1_int, p1w1_t, p1aw1a_int, p1aw1a_t);
...
// Implement generateDecorations by WrapCylinderNew to replace the previous out of place implementation 
// in ModelVisualizer
void WrapCylinderNew::generateDecorations(bool fixed, const ModelDisplayHints& hints, const SimTK::State& state,
    SimTK::Array_<SimTK::DecorativeGeometry>& appendToThis) const 
{
    ...
    if (hints.get_show_wrap_geometry()) {
        ...
        // WrapCylinderNew aligned with z
