#ifndef OPENSIM_WRAP_CYLINDER_NEW_H_
#define OPENSIM_WRAP_CYLINDER_NEW_H_
/* -------------------------------------------------------------------------- *
 *                          OpenSim:  WrapCylinderNew.h                          *
 * -------------------------------------------------------------------------- *
 ...
 */
class OSIMPLUGIN_API WrapCylinderNew : public WrapObject {
OpenSim_DECLARE_CONCRETE_OBJECT(WrapCylinderNew, WrapObject);
public:
//==============================================================================
// PROPERTIES
//==============================================================================
...
protected:
    ...
    // WrapTorus uses WrapCylinderNew::wrapLine.
