...
#ifdef Assisted
  const std::string BASE_MODEL_NAME = "vin_60pctAssisted.osim";
  const std::string OPTIM_MODEL_NAME = "vin_60pctAssisted.osim.mod";
  const std::string REPLAY_MODEL_NAME = "vin_60pctAssisted_replay.osim.mod";
